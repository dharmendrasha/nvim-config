...
-- they get installed to ~/.local/share/nvim-Adib/mason/bin/. However, if you also have
...
-- After:  PATH = "/Users/you/.local/share/nvim-Adib/mason/bin:/usr/local/bin:/usr/bin:/bin"
--
-- KEY FEATURES:
